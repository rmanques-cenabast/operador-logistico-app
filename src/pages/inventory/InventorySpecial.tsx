...
const InventorySpecial: React.FC = () => {
  ...
  const entradasStock = filteredAdjustments.reduce((acc, header) =>
  ...
  return (
    <>
      ...
      <main className="page-content">
        <h2 className="page-title">Entradas Especiales sin OC</h2>
        <p className="page-subtitle">Ingresos extraordinarios a título gratuito, donaciones o regularizaciones administrativas. (SAP 511)</p>
...
export default InventorySpecial;
